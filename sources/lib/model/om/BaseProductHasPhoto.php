...
/**
 * Base class that represents a row from the 'product_has_photo' table.
 *
 * 
 *
 ...
 */
abstract class BaseProductHasPhoto extends BaseObject  implements Persistent {
	...
	const PEER = 'ProductHasPhotoPeer';
	...
	public function setProductId($v)
	{
		...
		if ($this->product_id !== $v) {
			$this->product_id = $v;
			$this->modifiedColumns[] = ProductHasPhotoPeer::PRODUCT_ID;
		}
	...
	public function setPhotoId($v)
	{
		...
		if ($this->photo_id !== $v) {
			$this->photo_id = $v;
			$this->modifiedColumns[] = ProductHasPhotoPeer::PHOTO_ID;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			return $startcol + 2; // 2 = ProductHasPhotoPeer::NUM_COLUMNS - ProductHasPhotoPeer::NUM_LAZY_LOAD_COLUMNS).

		} catch (Exception $e) {
			throw new PropelException("Error populating ProductHasPhoto object", $e);
		}
	}
	...
	public function reload($deep = false, PropelPDO $con = null)
	{
		...
		$stmt = ProductHasPhotoPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
	...
	public function delete(PropelPDO $con = null)
	{
		...
		try {
			...
			foreach (sfMixer::getCallables('BaseProductHasPhoto:delete:pre') as $callable)
			{
			...
			if ($ret) {
				ProductHasPhotoPeer::doDelete($this, $con);
				$this->postDelete($con);
				// symfony_behaviors behavior
				foreach (sfMixer::getCallables('BaseProductHasPhoto:delete:post') as $callable)
				{
	...
	public function save(PropelPDO $con = null)
	{
		...
		try {
			...
			// symfony_behaviors behavior
			foreach (sfMixer::getCallables('BaseProductHasPhoto:save:pre') as $callable)
			{
			...
			if ($ret) {
				...
				$this->postSave($con);
				// symfony_behaviors behavior
				foreach (sfMixer::getCallables('BaseProductHasPhoto:save:post') as $callable)
				{
				  call_user_func($callable, $this, $con, $affectedRows);
				}

				ProductHasPhotoPeer::addInstanceToPool($this);
			} else {
				$affectedRows = 0;
			}
			$con->commit();
	...
	{
		$pos = ProductHasPhotoPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(ProductHasPhotoPeer::PRODUCT_ID)) $criteria->add(ProductHasPhotoPeer::PRODUCT_ID, $this->product_id);
		if ($this->isColumnModified(ProductHasPhotoPeer::PHOTO_ID)) $criteria->add(ProductHasPhotoPeer::PHOTO_ID, $this->photo_id);
	...
	public function buildPkeyCriteria()
	{
		...
		$criteria->add(ProductHasPhotoPeer::PRODUCT_ID, $this->product_id);
		$criteria->add(ProductHasPhotoPeer::PHOTO_ID, $this->photo_id);
	 ...
	 * objects.
	 *
	 * @param      object $copyObj An object of ProductHasPhoto (or compatible) type.
	 ...
	 *
	 * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
	 * @return     ProductHasPhoto Clone of current object.
	 * @throws     PropelException
	 */
	 ...
	 *
	 * @return     ProductHasPhotoPeer
	 */
	public function getPeer()
	{
		if (self::$peer === null) {
			self::$peer = new ProductHasPhotoPeer();
		}
		return self::$peer;
	}
	...
	public function getProduct(PropelPDO $con = null)
	{
		if ($this->aProduct === null && ($this->product_id !== null)) {
			...
			/* The following can be used additionally to
			   ...
			   $this->aProduct->addProductHasPhotos($this);
			 */
		}
	...
	public function getPhoto(PropelPDO $con = null)
	{
		if ($this->aPhoto === null && ($this->photo_id !== null)) {
			...
			/* The following can be used additionally to
			   ...
			   undesirable since it could result in an only partially populated collection
			   in the referenced object.
			   $this->aPhoto->addProductHasPhotos($this);
			 */
		}
		return $this->aPhoto;
	}
	...
	{
	  if (!$callable = sfMixer::getCallable('BaseProductHasPhoto:'.$method))
	  {
	    throw new sfException(sprintf('Call to undefined method BaseProductHasPhoto::%s', $method));
	  }
