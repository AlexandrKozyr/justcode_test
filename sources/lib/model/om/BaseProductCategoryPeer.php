...
abstract class BaseProductCategoryPeer {
	...
	const PARENT_ID = 'product_category.PARENT_ID';

	/** the column name for the TITLE field */
	const TITLE = 'product_category.TITLE';
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Id', 'ParentId', 'Title', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'parentId', 'title', ),
		BasePeer::TYPE_COLNAME => array (self::ID, self::PARENT_ID, self::TITLE, ),
		BasePeer::TYPE_FIELDNAME => array ('id', 'parent_id', 'title', ),
	...
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'ParentId' => 1, 'Title' => 2, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'parentId' => 1, 'title' => 2, ),
		BasePeer::TYPE_COLNAME => array (self::ID => 0, self::PARENT_ID => 1, self::TITLE => 2, ),
		BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'parent_id' => 1, 'title' => 2, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, )
	);
	...
	public static function addSelectColumns(Criteria $criteria)
	{
		...
		$criteria->addSelectColumn(ProductCategoryPeer::PARENT_ID);
		$criteria->addSelectColumn(ProductCategoryPeer::TITLE);
	}
	...
	{
    // symfony_behaviors behavior
    foreach (sfMixer::getCallables('BaseProductCategoryPeer:doInsert:pre') as $sf_hook)
    {
      if (false !== $sf_hook_retval = call_user_func($sf_hook, 'BaseProductCategoryPeer', $values, $con))
      {
    ...
    // symfony_behaviors behavior
    foreach (sfMixer::getCallables('BaseProductCategoryPeer:doInsert:post') as $sf_hook)
    {
      call_user_func($sf_hook, 'BaseProductCategoryPeer', $values, $con, $pk);
    }
	...
	{
    // symfony_behaviors behavior
    foreach (sfMixer::getCallables('BaseProductCategoryPeer:doUpdate:pre') as $sf_hook)
    {
      if (false !== $sf_hook_retval = call_user_func($sf_hook, 'BaseProductCategoryPeer', $values, $con))
      {
        return $sf_hook_retval;
    ...
    // symfony_behaviors behavior
    foreach (sfMixer::getCallables('BaseProductCategoryPeer:doUpdate:post') as $sf_hook)
    {
      call_user_func($sf_hook, 'BaseProductCategoryPeer', $values, $con, $ret);
    }
	...
	/**
	 * Method to DELETE all rows from the product_category table.
	 *
	 * @return     int The number of affected rows (if supported by underlying database driver).
	 */
	...
	static private function getMixerPreSelectHook($method)
	{
	  ...
	  {
	    return sprintf('BaseProductCategoryPeer:%s:%1$s', 'Count' == $match[1] ? 'doCount' : $match[0]);
	  }
